...
#define TOGGLE_SWITCH                                                          \
  "/sys/devices/platform/soc/c42d000.qcom,spmi/spmi-0/0-01/"                   \
  "c42d000.qcom,spmi:qcom,pmxr2230@1:qcom,flash_led@ee00/leds/led:switch_2"

static std::string kTorchLedPaths[] = {
    "/sys/devices/platform/soc/c42d000.qcom,spmi/spmi-0/0-01/"
    "c42d000.qcom,spmi:qcom,pmxr2230@1:qcom,flash_led@ee00/leds/led:torch_0",
    "/sys/devices/platform/soc/c42d000.qcom,spmi/spmi-0/0-01/"
    "c42d000.qcom,spmi:qcom,pmxr2230@1:qcom,flash_led@ee00/leds/led:torch_1",
    "/sys/devices/platform/soc/c42d000.qcom,spmi/spmi-0/0-01/"
    "c42d000.qcom,spmi:qcom,pmxr2230@1:qcom,flash_led@ee00/leds/led:torch_2",
    "/sys/devices/platform/soc/c42d000.qcom,spmi/spmi-0/0-01/"
    "c42d000.qcom,spmi:qcom,pmxr2230@1:qcom,flash_led@ee00/leds/led:torch_3",
};
...
bool supportsSetTorchModeExt() { return false; }

int32_t getTorchDefaultStrengthLevelExt() { return 50; }

int32_t getTorchMaxStrengthLevelExt() {
  // In our device, both LEDs has same maximum value
  // so get from one.
  auto node = kTorchLedPaths[0] + "/" + TORCH_MAX_BRIGHTNESS;
  return get(node, 0) * 0.6;
}
